...
@export var color_middle: Color = Color.from_rgba8(127, 127, 127, 255)
@export var color_end: Color = Color.from_rgba8(0, 0, 0, 255)
...
func _ready() -> void:
    ...
    if use_gradient:
        var color_start_value: Color = color_start
        var color_middle_value: Color = color_middle
        var color_end_value: Color = color_end
